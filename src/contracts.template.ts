...
export const wethGammaShortStrategyContract = GammaShortStrategy.bind(wethGammaShortStrategyAddress)
export const wbtcGammaShortStrategyContract = GammaShortStrategy.bind(wbtcGammaShortStrategyAddress)
